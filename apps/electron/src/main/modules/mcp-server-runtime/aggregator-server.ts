...
export class AggregatorServer {
  ...
  /**
   * Handle one stateless Streamable HTTP request.
   *
   * The MCP SDK prohibits reusing a stateless transport, so the server and
   * transport must have the same single-request lifetime.
   */
